...
var nullthrows = __webpack_require__(49);
...
function installHook(target) {
  ...
  function format(maybeMessage, ...inputArgs) {
    if (DevToolsFeatureFlags_extension_oss["a" /* consoleManagedByDevToolsDuringStrictMode */]) {
      const args = inputArgs.slice(); // Symbols cannot be concatenated with Strings.
  ...
  function patchConsoleForInitialRenderInExtension(renderer, {
